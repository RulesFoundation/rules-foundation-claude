...
gh issue create --repo PolicyEngine/policyengine-us \
  --title "[rac-validators] Potential calculation error: {description}" \
  --body "$(cat <<'EOF'
## Bug report (auto-generated by rac-validators)
...
---
*Auto-generated by rac-validators. Please verify before addressing.*
EOF
)"
```
